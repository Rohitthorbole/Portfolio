...
const Resume = () => {
  return (
    <>
      <div className='h-[2000px] max-w-[70vw] mt-[30px] bg-white mx-auto dark:text-black'>

        {/* start */}

        <div className='start flex justify-between mx-10 mt-10'>
          <div>
            <p className='text-[22px] text-blue-500 mt-12'>Rohit Vinod Thorbole</p>
            <p>B.C.A. - Science</p>
            <p className=''>rohitthorbole4@gmail.com</p>
            <p className='' >Ph : +919172198021</p>
            <p>Address: Alandi, Pune, Maharashtra.</p>
          </div>
          <img src="./Media/rohit.png" alt="" className='h-[180px] w-[140px] mt-10' />
        </div>
        ...
        <div className='summary h-[130px] mx-2 px-6 pt-2  bg-gray-100'>
        ...
        <div className='summary h-[40px] mx-2 px-6  bg-gray-100 flex items-center justify-center'>
        ...
        <div className='summary h-[120px] mx-2 px-6 pt-2  bg-gray-100'>
        ...
        <div className='summary h-[120px] mx-2 px-6 pt-2 mt-2  bg-gray-100'>
          ...
          <p>Link : <a href="https://github.com/Rohitthorbole/QRGenerator" className='text-blue-400'>https://github.com/Rohitthorbole/QRGenerator</a></p>
        </div>
        ...
        <div className='summary h-[120px] mx-2 px-6 pt-2 mt-2  bg-gray-100'>
          ...
          <p>Link : <a href="https://github.com/Rohitthorbole/Bodybalance" className='text-blue-400'>https://github.com/Rohitthorbole/Bodybalance</a></p>
        </div>
        ...
        <div className='summary h-[160px] mx-2 px-6 pt-2  bg-gray-100'>
